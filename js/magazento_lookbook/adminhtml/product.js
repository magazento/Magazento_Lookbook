Product.Magazentogallery = Class.create();
Product.Magazentogallery.prototype = {
    images : [],
    file2id : {
        'no_selection' :0
    },
    ...
    updateImage : function(file) {
        ...
        this.images[index].is_main = (this.getFileElement(file,
    ...
    setMainImage : function(file) {
        $H(this.imageTypes)
                .each(
                        function(pair) {
                            if (this.getFileElement(file,
                                    'cell-main input').checked) {
                                this.imagesValues['main'] = (file == 'no_selection' ? null
                                        : file);
                            }
                        }.bind(this));
    ...
    updateVisualisation : function(file) {
        ...
        this.getFileElement(file, 'cell-remove input').checked = (image.removed == 1);
         this.getFileElement(file, 'cell-main input').checked = (image.is_main == 1);
