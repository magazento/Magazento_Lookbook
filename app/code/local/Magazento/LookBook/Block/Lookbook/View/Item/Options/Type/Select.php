 ...
 */
class Magazento_LookBook_Block_Lookbook_View_Item_Options_Type_Select extends Mage_Catalog_Block_Product_View_Options_Type_Select
    ...
    public function getValuesHtml()
    {
        ...
        if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_DROP_DOWN
            ...
            if (!$this->getSkipJsReloadPrice()) {
                $extraParams .= ' onchange="opConfig['.$this->getProduct()->getId().'].reloadPrice()"';
            }
        ...
        if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_RADIO
            ...
            foreach ($_option->getValues() as $_value) {
                ...
                $selectHtml .= '<li>' . '<input type="' . $type . '" class="' . $class . ' ' . $require
                    ...
                    . ($this->getSkipJsReloadPrice() ? '' : ' onclick="opConfig['.$this->getProduct()->getId().'].reloadPrice()"')
