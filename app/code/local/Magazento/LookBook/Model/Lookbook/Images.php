 ...
 */
class Magazento_Lookbook_Model_Lookbook_Images extends Mage_Core_Model_Abstract
{
    protected $_width;
    protected $_height;
    ...
    {
        $this->_init('lookbook/lookbook_images');
    }

    /**
     * @return Magazento_Lookbook_Model_Lookbook_Image
     */
...
//        print '$this->_getNeedMemoryForBaseFile() = '.$this->_getNeedMemoryForBaseFile();
    ...
    public function setBaseFile($file)
    {
        ...
        $baseDir = Mage::getSingleton('lookbook/config')->getBaseMediaPath();
...
//            }
    ...
    public function clearCache()
    {
        ...
        $directory = Mage::getSingleton('lookbook/config')->getBaseMediaPath() .DS.'cache'.DS;
